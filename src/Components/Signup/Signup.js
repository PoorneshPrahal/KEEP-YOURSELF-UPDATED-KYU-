...
function Signup() {
  ...
  return (
    ...
    <div className='login-box'>
        <form className='form'>
        <h3>
  Ready to Dive In?  <span style={{ backgroundImage: 'linear-gradient(90deg, #C33764, #1D2671)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>Sign Up!</span>
</h3>   
        <label>UserName  </label>
            <input type='text' placeholder='Who are you today?' className='inpt-user' onChange={(e)=>{setname(e.target.value)}}/>
            <label>Email  </label>
           ...
           <p className='login-text'>One among us? <a href='#'>Log in!</a></p>
