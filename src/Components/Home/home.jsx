  ...
  return (
    <div>
      ...
      <div id="footer" style={{padding: "0px"}}>
            <section class="section-no-border pb-3">
             
                <footer class="page-footer font-small mdb-color pt-4" style={{paddingLeft: "0px"}}>
                  ...
                  <div class="container text-center text-md-left">
                    ...
                    <div class="row text-center text-md-left mt-3 pb-3">
                      ...
                      <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                        ...
                        <p>
                          <a class="nav-link" href="#">Why trade with us</a>
                        </p>
                        <p>
                          <a class="nav-link" href="#">Promising features</a>
                        </p>
                        <p>
                          <a class="nav-link" href="#">Our partners</a>
                        </p>
                        <p>
                          <a class="nav-link" href="#">Materials we take</a>
                        </p>
                        <p>
                      ...
                      <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3" >
                        <h6 class="text-uppercase mb-4 font-weight-bold" style={{textAlign : "center"}}>Location</h6>
                        <p style={{textAlign : "left", lineHeight: "1.8em",marginLeft:"20px"}}>
                          OLD NO.222/1, NEW NO.5/1, CHAKKRA GARDEN, GOMATHI
                            AMMAN NAGAR, VILANGADUPAKKAM, REDHILLS, Chennai,
                            Tamil Nadu, 600052
                        </p>
                      </div>
                      ...
                      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                        ...
                        <p>
                          <i class="fas fa-envelope mr-3"></i>Email: rammu1314@gmail.com</p>
                        <p>
                          <i class="fas fa-phone mr-3"></i>Call: 7200033188, 9840581912</p>
                      </div>
                    ...
                    <div class="row d-flex align-items-center">
                      ...
                      <div class="col-md-5 col-lg-4 ml-lg-0">
                        ...
                        <div class="text-center text-md-right" style={{marginTop : "-50px", marginLeft : "-30px"}}>
